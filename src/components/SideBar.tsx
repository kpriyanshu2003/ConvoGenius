...
function SideBar({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
      <div
        className={`py-4 bg-[#171717] h-screen transition-all duration-300 ${
          state ? "w-72 px-4" : "w-0 px-0"
        }`}
      >
        <div
          onClick={() => router.push("/")}
        ...
        >
          <div className="flex items-center gap-3">
            <div className="border w-8 px-2 aspect-square flex h-full items-center justify-center rounded-full bg-white text-gray-950">
              <svg
                width="41"
                height="41"
                viewBox="0 0 41 41"
          ...
          {state ?? <RxPencil2 className="w-6 h-6  top-3 -right-14" />}
      ...
      <IoIosArrowForward
        ...
        className={` w-8 h-8 transition duration-300 cursor-pointer ${
